...
git clone https://github.com/suanlou/bazi-skills.git ~/.claude/skills/miaosuan-bazi
...
```bash
# Codex
git clone https://github.com/suanlou/bazi-skills.git ~/.codex/skills/miaosuan-bazi
...
```bash
git clone https://github.com/suanlou/bazi-skills.git ~/suanlou
cd ~/suanlou
python3 -m venv .venv
. .venv/bin/activate
pip install -e ".[mcp]"
...
```text
https://github.com/suanlou/bazi-skills/blob/main/SKILL.md
```
